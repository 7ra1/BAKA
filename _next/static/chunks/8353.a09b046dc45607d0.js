...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [8353],
  {
    95519: function (e, t, n) {
      ...
      var a = function (e) {
        ...
        return o.default.createElement(
          "div",
          { "aria-live": r, "aria-atomic": "true", style: i, tabIndex: -1 },
          t
        );
      };
      t.default = a;
      ...
      var S = function (e) {
        var t = e,
          ...
          be = (0, o.useCallback)(function (e) {
            e &&
              e.querySelectorAll(".slider-list img").forEach(function (e) {
          ...
          he = (0, o.useCallback)(
            function (e) {
              if (de.current && me.current) {
                ...
                n && h(G, t);
                var r =
                    de.current.getBoundingClientRect().left -
                    me.current.getBoundingClientRect().left,
                  o = de.current.offsetWidth,
                  i =
                    ((0, u.getPercentOffsetForSlide)(t, K, W, S, F) / 100) * o;
                if (F) {
                  var a = o / 3;
                  e < 0 && (i += a), e >= K && (i -= a);
                }
        ...
        var Ce = (0, o.useRef)([]),
          Pe = function (e) {
            if (ne && me.current) {
              ...
              if (Ce.current.length > 1)
                for (
                  var n = Ce.current[0],
                    r = Ce.current[Ce.current.length - 1],
                    o = r.time - n.time,
                    i = 9 * Math.abs((r.pos - n.pos) / o);
                  Math.abs(i) > 1;
              ...
              if (a < l) he(G);
                ...
                for (
                  var c = W >= 2 * q ? 1 + Math.floor((a - l) / u) : 1,
                    f = G,
                    d = 0;
                  d < c;
                  d += 1
                  ...
                  f =
                    ie > 0
                      ? (0, s.getNextMoveIndex)(_, F, f, K, q, W, S)
                      : (0, s.getPrevMoveIndex)(_, F, f, q, W, S);
                f !== G && T(e), he(f);
              }
            }
          },
          ...
          Me = (0, o.useCallback)(
            function (e) {
              if (ne) {
                for (
                  var t = null === se.current,
                    n = null !== se.current ? e - se.current : 0,
                    r = ie + n,
                    o = Date.now();
                  Ce.current.length > 0 && !(o - Ce.current[0].time <= 100);

                )
                  Ce.current.shift();
                Ce.current.push({ pos: r, time: o }),
                  t || ae(r),
                  (se.current = e);
              }
            },
        ...
        return o.default.createElement(
          ...
          o.default.createElement(a.default, {
            ...
            message: N({ currentSlide: G, count: K }),
          }),
          (0, l.default)(t, K, G, he, Se, Oe, q),
          o.default.createElement(
            ...
            o.default.createElement(
              ...
              F ? _e("prev-cloned") : null,
              _e(),
              F ? _e("next-cloned") : null
            )
          )
        );
      };
    ...
    16971: function (e, t, n) {
      ...
      var d = [
          { funcName: "renderTopLeftControls", key: u.Positions.TopLeft },
          { funcName: "renderTopCenterControls", key: u.Positions.TopCenter },
          { funcName: "renderTopRightControls", key: u.Positions.TopRight },
          { funcName: "renderCenterLeftControls", key: u.Positions.CenterLeft },
          {
          ...
          { funcName: "renderBottomLeftControls", key: u.Positions.BottomLeft },
          {
        ...
        p = function (e, t, n, r, u, l, c) {
          ...
          var f = s(s({}, e), {}, { currentSlide: n, slideCount: t }),
          ...
          return d.map(function (a) {
            var f;
            return e[a.funcName] && "function" === typeof e[a.funcName]
              ? o.default.createElement(
                  "div",
                  {
                    key: a.funcName,
                    style: s(
                      s({}, (0, i.getControlContainerStyles)(a.key)),
                      {},
                      { pointerEvents: "none" }
                    ),
                  },
                  o.default.createElement(
                    ...
                    {
                      className: [
                        "slider-control-".concat(a.key.toLowerCase()),
              ...
              : o.default.createElement(o.Fragment, { key: a.funcName });
          });
        };
      t.default = p;
    },
      ...
      var u = function (e) {
        ...
        l = {
          ...
          renderAnnounceSlideMessage:
            n(95519).defaultRenderAnnounceSlideMessage,
    ...
    40418: function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.prevButtonDisabled =
          t.nextButtonDisabled =
          t.getDotIndexes =
          t.PreviousButton =
          t.PagingDots =
          t.NextButton =
      ...
      t.PreviousButton = function (e) {
        ...
        return o.default.createElement(
          "button",
          {
            ...
            onClick: function (e) {
              null === l || void 0 === l || l(e),
                e.defaultPrevented || (s(e), e.preventDefault(), t());
            },
            "aria-label": "previous",
            type: "button",
          },
      ...
      t.NextButton = function (e) {
        ...
        return o.default.createElement(
          "button",
          {
            ...
            onClick: function (e) {
              null === l || void 0 === l || l(e),
                e.defaultPrevented || (d(e), e.preventDefault(), t());
            },
            "aria-label": "next",
            type: "button",
          },
      ...
      t.getDotIndexes = function (e, t, n, r, o, a) {
        ...
        if ("left" === a) {
          ...
          return (
            n === i.ScrollMode.remainder
              ? u.push(f)
              : u.push(u[u.length - 1] + l),
            u
          );
        }
        if ("right" === a) {
      ...
      t.PagingDots = function (e) {
        ...
        return o.default.createElement(
          ...
          t.map(function (e, n) {
            ...
            return o.default.createElement(
              "li",
              { key: e, className: r ? "paging-item active" : "paging-item" },
              o.default.createElement(
                "button",
                {
                  className: i,
            ...
            function (e, r) {
              ...
              (o =
                null === r
                  ...
                  : [].concat(i(a), [{ slideIndex: e, height: r }])),
                c(o),
                o.length >= Math.min(n, Math.ceil(t)) && p(!0);
            },
            [n, c, t, s]
          ),
          frameHeight: (0, r.useMemo)(
            function () {
              if (e) {
                if (!d) return "auto";
    ...
    54923: function (e, t, n) {
      ...
      t.useTween = function (e, t, n, i) {
        ...
        return (
            ...
            function () {
              if (((d.current = n), f.current)) f.current = !1;
                ...
                return (
                  ...
                  function () {
                    void 0 !== s.current &&
                      (cancelAnimationFrame(s.current), l(1));
                  }
                );
              }
            },
          ...
          { isAnimating: 1 !== p, value: t(p) }
        );
      };
    },
    33752: function (e, t, n) {
      Object.defineProperty(t, "__esModule", { value: !0 });
      var r = { NextButton: !0, PreviousButton: !0, PagingDots: !0 };
    ...
    78056: function (e, t, n) {
      ...
      var l = o.default.forwardRef(function (e, t) {
        ...
        var D,
          A = u.apply(void 0, [s].concat(P)),
          k =
            !d &&
            !w &&
            ((s === j[0] && r < 0) || (s === j[j.length - 1] && r > 0)),
    ...
    87353: function (e, t, n) {
      ...
      t.isSlideVisible = function (e, t, n, r) {
        return "left" === r
          ? t < e + n && t > e - 1
          : "center" === r
          ? (t > e - n / 2 - 0.5 && t <= e) || (t > e && t < e + n / 2 + 0.5)
          : "right" === r && t < e + 1 && t > e - n;
      };
      t.getNextMoveIndex = function (e, t, n, r, i, a, u) {
        return t
          ...
          : n >= r - 1 || ("left" === u && n >= r - a)
          ? n
          : e === o.ScrollMode.remainder && "left" === u
          ? Math.min(n + i, r - a)
          : Math.min(n + i, r - 1);
      };
      t.getPrevMoveIndex = function (e, t, n, r, i, a) {
        return t
          ...
          : n <= 0 || ("right" === a && n <= i - 1)
          ? n
          : e === o.ScrollMode.remainder && "right" === a
          ? Math.max(n - r, i - 1)
          : Math.max(n - r, 0);
      };
    ...
    42708: function (e, t, n) {
          ...
          .map((t) => {
            return `${t}_${
              "root" === t
                ? ((n = e.root),
                  n
                    ? (u.has(n) || ((l += 1), u.set(n, l.toString())), u.get(n))
                    : "0")
                : e[t]
            }`;
            var n;
        ...
        return (
          ...
          function () {
            l.splice(l.indexOf(t), 1),
              0 === l.length && (u.delete(e), i.unobserve(e)),
              0 === u.size && (i.disconnect(), a.delete(o));
          }
        );
      }
      r.Component;
      function d({
        ...
        const [p, g] = r.useState(null),
          y = r.useRef(),
          [v, b] = r.useState({ inView: !!l, entry: void 0 });
        (y.current = s),
          r.useEffect(() => {
            if (u || !p) return;
            let r;
        ...
        p ||
          ...
          u ||
          h.current === m ||
          ((h.current = m), b({ inView: !!l, entry: void 0 }));
